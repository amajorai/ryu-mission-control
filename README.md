<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="Mission Control" width="144" />
  </picture>
</p>
...
The project-level view over many chats: recent sessions and what each one accomplished, per-day activity, the files several chats keep returning to, and the to-dos left outstanding in threads nobody reopened. Digests are computed by the client, so every surface agrees.
...
**App:** [Install](ryu://apps/@ryu/mission-control) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/mission-control
```

**Crate:**

```bash
cargo install ryu-mission-control
```
...
<a href="https://github.com/amajorai/ryu-mission-control/stargazers">
  <picture>
